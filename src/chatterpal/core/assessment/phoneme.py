...
class PhonemeAnalyzer(AssessmentBase):
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        # 标准日语元音共振峰数据 (Hz) - 基于成年平均值
        self.standard_vowels = {
            "a": {"F1": 750, "F2": 1180, "F3": 2500, "name": "a (あ)"},
            "i": {"F1": 310, "F2": 2250, "F3": 3000, "name": "i (い)"},
            "u": {"F1": 360, "F2": 1400, "F3": 2500, "name": "u (う)"},
            "e": {"F1": 490, "F2": 1850, "F3": 2600, "name": "e (え)"},
            "o": {"F1": 460, "F2": 950, "F3": 2500, "name": "o (お)"},
        }
