...
class TestServiceTimeoutScenarios:
    ...
    def test_tts_service_timeout(self):
        ...
        assert audio_output == (16000, [])  # TTS超时，没有音频输出
