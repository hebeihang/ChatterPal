...
from src.oralcounsellor.core.errors import error_handler, ChatModuleError
...
class TestIntegratedErrorHandling:
    ...
    def test_partial_failure_graceful_degradation(self):
        ...
        assert audio_output == (16000, [])  # TTS失败，没有音频
    ...
    def test_error_logging_integration(self):
        """测试错误日志记录的集成"""
        with patch('src.oralcounsellor.core.errors.error_handler.log_error') as mock_log_error:
            session_id = self.chat_service.create_session()
