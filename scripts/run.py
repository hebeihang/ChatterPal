...
class ChatterPalRunner:
    ...
    def run_web_app(self, port: Optional[int] = None, share: bool = False, 
        ...
        try:
            ...
            from chatterpal.utils import setup_logging
            ...
            if not debug:
                ...
                log_config['log_file'] = str(self.project_root / "logs" / "chatterpal.log")
