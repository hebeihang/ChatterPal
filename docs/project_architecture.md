# OralCounsellor 项目架构文档

## 项目概述

OralCounsellor 是一个基于 AI 的英语口语练习系统，提供智能对话练习和发音纠错功能。项目采用前后端分离架构，后端使用 Python + Gradio，前端使用 React + TypeScript。
...
本文档提供了 OralCounsellor 项目的完整架构概览，涵盖了技术栈、模块设计、数据流、部署方案等各个方面，为开发者理解和维护项目提供了全面的参考。